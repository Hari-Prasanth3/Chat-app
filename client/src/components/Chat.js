...
const Chat = () => {
    ...
    useEffect(() => {
      ...
      newSocket.onmessage = (event) => {
        ...
        if (typeof newMessage === 'string') {
          // If the message is a string, add it to the chatMessages state directly
    ...
    return (
      <div className="App">
        <div id="username-container" style={{ display: username ? 'none' : 'block' }}>
        ...
        <div id="container" style={{ display: username ? 'block' : 'none' }}>
